...
Việc đánh giá được thực hiện trên tập dữ liệu thực tế từ hệ thống, bao gồm 2.000 CV và 5.000 công việc. Bảng \ref{tab:dataset-stats} trình bày thống kê chi tiết về bộ dữ liệu đánh giá.

\begin{table}[H]
\centering
\caption{Thống kê bộ dữ liệu đánh giá}
...
Số lượng CV & 2.000 \\
\hline
Số lượng công việc & 5.000 \\
\hline
Tổng số cặp có thể & 10.000.000 \\
\hline
Tỷ lệ CV/công việc & 0,4 \\
\hline
\end{tabular}
\end{table}
...
Do không có dữ liệu được gán nhãn thủ công từ người dùng thực, hệ thống sử dụng phương pháp so khớp dựa trên quy tắc làm cơ sở đánh giá. Phương pháp này kết hợp hai tiêu chí chính.

Tiêu chí thứ nhất đánh giá độ tương đồng tiêu đề sử dụng bốn độ đo bao gồm Jaccard, độ tương đồng chuỗi, TF-IDF và độ tương đồng ngữ nghĩa. Một cặp CV-công việc được coi là khớp về tiêu đề nếu điểm tổng hợp vượt ngưỡng 0,6.

Tiêu chí thứ hai đánh giá độ khớp kỹ năng thông qua năm mức độ: khớp chính xác, khớp từ đồng nghĩa, khớp theo mẫu, khớp một phần và khớp theo danh mục. Hệ thống sử dụng từ điển ánh xạ kỹ năng Việt-Anh với hơn 100 cặp từ và phân loại kỹ năng theo các nhóm như frontend, backend, devops, cơ sở dữ liệu, di động và dữ liệu.

Một cặp CV-công việc được coi là phù hợp nếu thỏa mãn cả hai tiêu chí trên. Phương pháp này cho phép tạo nhãn tự động với chi phí thấp trong khi vẫn đảm bảo tính hợp lý của kết quả.
